...
describe('XSS Sanitization and Injection Protection Tests', () => {
  it('should strip script tags and onload/onerror handlers completely from input text', () => {
  ...
  it('should allow only safe formatting tags in HTML output and strip script tags', () => {
  ...
  it('should escape special HTML entities correctly for display', () => {
